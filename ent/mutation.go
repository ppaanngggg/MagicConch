...
func (m *SystemMutation) SetSystem(s string) {
	m.system = &s
}

// System returns the value of the "system" field in the mutation.
func (m *SystemMutation) System() (r string, exists bool) {
	v := m.system
	if v == nil {
		return
	}
...
// OldSystem returns the old "system" field's value of the System entity.
// If the System object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SystemMutation) OldSystem(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SystemMutation) ResetSystem() {
	m.system = nil
}

// SetClickTime sets the "click_time" field.
func (m *SystemMutation) SetClickTime(t time.Time) {
	m.click_time = &t
}

// ClickTime returns the value of the "click_time" field in the mutation.
func (m *SystemMutation) ClickTime() (r time.Time, exists bool) {
	v := m.click_time
	if v == nil {
		return
	}
...
// OldClickTime returns the old "click_time" field's value of the System entity.
// If the System object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SystemMutation) OldClickTime(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldClickTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldClickTime requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldClickTime: %w", err)
	}
	return oldValue.ClickTime, nil
}

// ResetClickTime resets all changes to the "click_time" field.
func (m *SystemMutation) ResetClickTime() {
	m.click_time = nil
}
...
func (m *SystemMutation) Fields() []string {
	...
	if m.system != nil {
		fields = append(fields, system.FieldSystem)
	}
	if m.click_time != nil {
		fields = append(fields, system.FieldClickTime)
	}
	return fields
}
